...
var AppComponent = /** @class */ (function () {
     ...
     *
     */
    function AppComponent(_simulator) {
        this._simulator = _simulator;
        this.title = 'angularEndpoint';
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        window.addEventListener('devicemotion', function (event) {
            ...
            _this.acceleration_x = event.acceleration.x + ' m/s2';
            _this.acceleration_y = event.acceleration.y + ' m/s2';
            _this.acceleration_z = event.acceleration.z + ' m/s2';
            _this._simulator.sendData();
        });
    };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_simulator_service__WEBPACK_IMPORTED_MODULE_2__["SimulatorService"]])
    ], AppComponent);
    return AppComponent;
}());
...
module.exports = __webpack_require__(/*! C:\Users\abhina663445\Desktop\Node simulator\angularEndpoint\src\main.ts */"./src/main.ts");
